...
{
    internal class ReportWithFiltersForCountSpecification : BaseSpecification<Report>
    {
        public ReportWithFiltersForCountSpecification(ReportSpecParams reportSpecParams) : base(x =>
