...
namespace API.Controllers
{
    ...
    public class TitleController : ControllerBase
    {
        ...
        //
        // public TitleController(IGenericRepository<Appointed> titleRepo, DataContext context, IMapper mapper)
        // {
        ...
        //
        //     var data = _mapper.Map<IReadOnlyList<Appointed>, IReadOnlyList<PropertyDto>>(titles);
        //
        ...
        //
        // [HttpGet("{id}")]
        // public async Task<ActionResult<Appointed>> Title(int id)
        // {
